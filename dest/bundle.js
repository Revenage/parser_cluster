...
(0, _jquery2.default)(function () {
    var Parser = function () {
        function Parser() {
            ...
            this.host = (0, _jquery2.default)('#host');
            this.enter = (0, _jquery2.default)('#enter');
            this.order = (0, _jquery2.default)('#order');
            this.exit = (0, _jquery2.default)('#exit');
        }
        ...
        _createClass(Parser, [{
            ...
            key: 'renderTable',
            value: function renderTable(arr) {
                return this.proxyByOrder(arr).map(this.renderRow.bind(this)).join('');
            }
        }, {
            key: 'renderRow',
            ...
            key: 'proxyByOrder',
            value: function proxyByOrder(arr) {
                return arr.map(function (row) {
                    return row.split(' ').filter(Boolean);
                });
            }
        }, {
            key: 'renderOrderPreview',
            value: function renderOrderPreview(exitArr) {
                var preview = exitArr.map(function (val) {
            ...
            value: function renderOrder() {
                var host = this.getHost();
                var arr = this.getInputArray();
                var ordered = this.proxyByOrder(arr);
                var enter = arr[0];
                var exit = ordered[0];
    ...
    var preparseButton = (0, _jquery2.default)('#preparse');
    preparseButton.on('click', function () {
        return parser.preparse();
    });
    var parseButton = (0, _jquery2.default)('#parse');
